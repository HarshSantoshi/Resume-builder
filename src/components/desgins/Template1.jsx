            ...
            <div className="col-span-8 flex flex-col items-center justify-start py-6 bg-white">
              ...
              <div className="w-full px-8 py-6 bg-yellow-500">
                ...
                <input
                  ...
                  type="text"
                  readOnly="true"
                  className={`bg-transparent outline-none border-none text-xl tracking-widest uppercase  w-full ${
                    isEdit && "text-white"
                  }`}
                />
              </div>
              ...
              <div className="w-full px-8 py-6 flex flex-col items-start justify-start gap-6">
                <div className="w-full">
                  ...
                  <textarea
                    readOnly="true"
                    className={`text-base  tracking-wider w-full  outline-none border-none ${
                            ...
                            <div className="w-full flex items-center justify-between">
                              <div className="flex items-center justify-center">
                                <input
                                  ...
                                  type="text"
                                  readOnly="true"
                                  className={` outline-none border-none text-base tracking-wide capitalize font-semibold  w-full ${
                                    isEdit ? "bg-gray-200" : "bg-transparent"
                                  }`}
                                />
